...
PREINSTALLED_OPENROAD_PATH="scratch/seunghye/codesign/openroad_interface/OpenROAD/build/src/openroad"
PREINSTALLED_SCALEHLS_PATH="scratch/seunghye/codesign/ScaleHLS-HIDA"
PREINSTALLED_STREAMHLS_PATH="scratch/seunghye/codesign/Stream-HLS"
