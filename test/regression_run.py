...
class RegressionRun:
    ...
    def run_single_job(self, config_path, config_name, job_results_dir, dsp_override=None):
        ...
        scalehls_preinstalled_path_option = f'--preinstalled_scalehls_path {self.preinstalled_scalehls_path} ' if self.preinstalled_scalehls_path is not None else ''
        streamhls_preinstalled_path_option = f'--preinstalled_streamhls_path {self.preinstalled_streamhls_path} ' if self.preinstalled_streamhls_path is not None else ''
